package net.slimefog.tutorialmod.enchantment;
...
import net.slimefog.tutorialmod.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantments {
    ...
    public static void bootstrap(Registerable<Enchantment> registerable) {
        ...
        register(registerable, LIGHTNING_STRIKER, Enchantment.builder(Enchantment.definition(
                ...
                2,
                AttributeModifierSlot.MAINHAND)).exclusiveSet(enchantments.getOrThrow(EnchantmentTags.DAMAGE_EXCLUSIVE_SET)).addEffect(EnchantmentEffectComponentTypes.POST_ATTACK,
